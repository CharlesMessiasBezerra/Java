...
public class JGraph extends JFrame {
	...
	private static JMenu SubMenuArvore;
	private static JMenuItem SubMenuCentroArvore;
	...
	private static void onLoadControls() {
		...
		SubMenuArvore = new JMenu("Arvores");


		SubMenuCentroArvore = new JMenuItem("Centro da Arvore");
		SubMenuCentroArvore.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
		...
		SubMenuArvore.add(SubMenuCentroArvore);
